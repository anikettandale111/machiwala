        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul aria-expanded="false">
                    <li><a href="{{ route('form/input/new') }}">Received</a></li>
                    <li><a href="{{ route('form/input/new') }}">Pending</a></li>
                    <li><a href="{{ route('form/input/new') }}">Completed</a></li>
                    <li><a href="{{ route('form/input/new') }}">Cancelled</a></li>
                </ul>
            </li>
            <!-- <li>
